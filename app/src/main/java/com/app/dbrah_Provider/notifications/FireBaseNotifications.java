...
import com.app.dbrah_Provider.model.ClientModel;
import com.app.dbrah_Provider.model.MessageModel;
import com.app.dbrah_Provider.model.NotiFire;
import com.app.dbrah_Provider.model.RepresentModel;
    ...
    private void manageNotification(Map<String, String> map) {
        ...
        if (notification_type.equals("chat")) {
            ...
            if (getRoomId() != null && (order_id.equals(getRoomId().getOrder_id())
                ...
                if (className.equals("com.app.dbrah_Provider.uis.activity_chat.ChatActivity")) {
