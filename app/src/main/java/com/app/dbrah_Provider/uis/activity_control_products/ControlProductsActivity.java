...
import com.app.dbrah_Provider.adapter.SubSubProductCategoryAdapter;
    ...
    private void initView() {
        ...
        mvvm.getOnSubSubCategoryDataSuccess().observe(this, modelList -> {
            if (subSubProductCategoryAdapter != null) {
                ...
                subSubProductCategoryAdapter = new SubSubProductCategoryAdapter(ControlProductsActivity.this, getLang());
                binding.recViewSubSub.setAdapter(subSubProductCategoryAdapter);
                binding.recViewSubSub.setLayoutManager(new LinearLayoutManager(ControlProductsActivity.this, RecyclerView.HORIZONTAL, false));
        ...
        subSubProductCategoryAdapter = new SubSubProductCategoryAdapter(this, getLang());
        binding.recViewSubSub.setAdapter(subSubProductCategoryAdapter);
        binding.recViewSubSub.setLayoutManager(new LinearLayoutManager(this, RecyclerView.HORIZONTAL, false));
